...
import com.example.pettalk.jwt.JwtAuthenticationFilter;
import com.example.pettalk.jwt.JwtAuthorizationFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests((authorizeHttpRequests) ->
                authorizeHttpRequests
                        ...
                        .requestMatchers("/user/signup").permitAll() // '/user/signup' 으로 시작하는 요청 모두 접근 허가
                        .requestMatchers("/user/login").permitAll() // '/user/login' 으로 시작하는 요청 모두 접근 허가
